...
public class ArtCollectibleContract extends Contract {
    ...
    public static final String FUNC_FETCHTOKENSSTATISTICSBYADDRESS = "fetchTokensStatisticsByAddress";
    ...
    public static final Event ARTCOLLECTIBLEMINTED_EVENT = new Event("ArtCollectibleMinted", 
    ...
    @Deprecated
    protected ArtCollectibleContract(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected ArtCollectibleContract(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected ArtCollectibleContract(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected ArtCollectibleContract(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public static List<ArtCollectibleMintedEventResponse> getArtCollectibleMintedEvents(TransactionReceipt transactionReceipt) {
        List<EventValuesWithLog> valueList = staticExtractEventParametersWithLog(ARTCOLLECTIBLEMINTED_EVENT, transactionReceipt);
        ArrayList<ArtCollectibleMintedEventResponse> responses = new ArrayList<ArtCollectibleMintedEventResponse>(valueList.size());
        for (EventValuesWithLog eventValues : valueList) {
            ArtCollectibleMintedEventResponse typedResponse = new ArtCollectibleMintedEventResponse();
            typedResponse.log = eventValues.getLog();
            ...
            typedResponse.metadata = (String) eventValues.getNonIndexedValues().get(2).getValue();
            typedResponse.royalty = (BigInteger) eventValues.getNonIndexedValues().get(3).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }

    public Flowable<ArtCollectibleMintedEventResponse> artCollectibleMintedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, ArtCollectibleMintedEventResponse>() {
            @Override
            public ArtCollectibleMintedEventResponse apply(Log log) {
                EventValuesWithLog eventValues = extractEventParametersWithLog(ARTCOLLECTIBLEMINTED_EVENT, log);
                ArtCollectibleMintedEventResponse typedResponse = new ArtCollectibleMintedEventResponse();
                typedResponse.log = log;
                typedResponse.tokenId = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
                typedResponse.creator = (String) eventValues.getNonIndexedValues().get(1).getValue();
    ...
    public Flowable<ArtCollectibleMintedEventResponse> artCollectibleMintedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(ARTCOLLECTIBLEMINTED_EVENT));
        return artCollectibleMintedEventFlowable(filter);
    }
    ...
    public RemoteFunctionCall<BigInteger> countTokensCreatorByAddress(String creatorAddress) {
    ...
    public RemoteFunctionCall<BigInteger> countTokensOwnedByAddress(String ownerAddress) {
    ...
    public RemoteFunctionCall<TokenStatistics> fetchTokensStatisticsByAddress(String targetAddress) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_FETCHTOKENSSTATISTICSBYADDRESS, 
                Arrays.<Type>asList(new Address(160, targetAddress)),
                Arrays.<TypeReference<?>>asList(new TypeReference<TokenStatistics>() {}));
        return executeRemoteCallSingleValueReturn(function, TokenStatistics.class);
    }
    ...
    public RemoteFunctionCall<String> getTokenCreatorById(BigInteger tokenId) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETTOKENCREATORBYID, 
                Arrays.<Type>asList(new Uint256(tokenId)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }

    public RemoteFunctionCall<List> getTokens(List<BigInteger> tokenIds) {
    ...
    public RemoteFunctionCall<List> getTokensOwnedByMe() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETTOKENSOWNEDBYME, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<DynamicArray<ArtCollectible>>() {}));
        return new RemoteFunctionCall<List>(function,
                new Callable<List>() {
    ...
    public RemoteFunctionCall<TransactionReceipt> mintToken(String metadataCid, BigInteger royalty) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_MINTTOKEN, 
                Arrays.<Type>asList(new Utf8String(metadataCid),
                new Uint256(royalty)),
    ...
    public RemoteFunctionCall<TransactionReceipt> setMarketPlaceAddress(String marketPlaceAddress) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETMARKETPLACEADDRESS, 
                Arrays.<Type>asList(new Address(160, marketPlaceAddress)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    @Deprecated
    public static ArtCollectibleContract load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ArtCollectibleContract(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ArtCollectibleContract load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ArtCollectibleContract(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static ArtCollectibleContract load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new ArtCollectibleContract(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static ArtCollectibleContract load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new ArtCollectibleContract(contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public static class TokenStatistics extends StaticStruct {
        public BigInteger countTokensCreator;

        public BigInteger countTokensOwned;

        public TokenStatistics(BigInteger countTokensCreator, BigInteger countTokensOwned) {
            super(new Uint256(countTokensCreator),
                    new Uint256(countTokensOwned));
            this.countTokensCreator = countTokensCreator;
            this.countTokensOwned = countTokensOwned;
        }

        public TokenStatistics(Uint256 countTokensCreator, Uint256 countTokensOwned) {
            super(countTokensCreator, countTokensOwned);
            this.countTokensCreator = countTokensCreator.getValue();
            this.countTokensOwned = countTokensOwned.getValue();
        }
    }
    ...
    public static class ArtCollectible extends DynamicStruct {
        ...
        public ArtCollectible(BigInteger tokenId, String creator, String owner, BigInteger royalty, String metadataCID, Boolean isExist) {
        ...
        public ArtCollectible(Uint256 tokenId, Address creator, Address owner, Uint256 royalty, Utf8String metadataCID, Bool isExist) {
            super(tokenId, creator, owner, royalty, metadataCID, isExist);
    ...
    public static class ArtCollectibleMintedEventResponse extends BaseEventResponse {
        public BigInteger tokenId;
